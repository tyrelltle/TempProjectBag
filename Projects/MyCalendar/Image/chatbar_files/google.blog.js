window['___jsl']={'u':'http:\/\/www-fc-opensocial.googleusercontent.com\/gadgets\/js\/google.blog.js?container=peoplesense&nocache=0&debug=0&c=0&v=e57c2879fdcfe031bdfdb338cb82b225&sv=1','f':['google.blog']};
...
var goog=goog||{};goog.global=this;goog.DEBUG=true;goog.LOCALE="en";goog.evalWorksForGlobals_=null;goog.provide=function(a){goog.exportPath_(a)};goog.setTestOnly=function(a){if(!goog.DEBUG){a=a||"";throw Error("Importing test-only code into non-debug environment"+a?": "+a:".");}};goog.exportPath_=function(a,b,c){a=a.split(".");c=c||goog.global;!(a[0]in c)&&c.execScript&&c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)if(!a.length&&goog.isDef(b))c[d]=b;else c=c[d]?c[d]:c[d]={}};
goog.getObjectByName=function(a,b){for(var c=a.split("."),d=b||goog.global,e;e=c.shift();)if(goog.isDefAndNotNull(d[e]))d=d[e];else return null;return d};goog.globalize=function(a,b){var c=b||goog.global,d;for(d in a)c[d]=a[d]};goog.addDependency=function(){};goog.useStrictRequires=false;goog.require=function(){};goog.basePath="";goog.nullFunction=function(){};goog.identityFunction=function(a){return a};goog.abstractMethod=function(){throw Error("unimplemented abstract method");};
...
b.body.appendChild(c);b.body.removeChild(c)}}else throw Error("goog.globalEval not available");};goog.typedef=true;goog.getCssName=function(a,b){var c=function(e){return goog.cssNameMapping_[e]||e},d=function(e){e=e.split("-");for(var f=[],g=0;g<e.length;g++)f.push(c(e[g]));return f.join("-")};d=goog.cssNameMapping_?goog.cssNameMappingStyle_=="BY_WHOLE"?c:d:function(e){return e};return b?a+"-"+d(b):d(a)};goog.setCssNameMapping=function(a,b){goog.cssNameMapping_=a;goog.cssNameMappingStyle_=b};
...
goog.scope=function(a){a.call(goog.global)};goog.MODIFY_FUNCTION_PROTOTYPES=true;
if(goog.MODIFY_FUNCTION_PROTOTYPES){Function.prototype.bind=Function.prototype.bind||function(a){if(arguments.length>1){var b=Array.prototype.slice.call(arguments,1);b.unshift(this,a);return goog.bind.apply(null,b)}else return goog.bind(this,a)};Function.prototype.partial=function(){var a=Array.prototype.slice.call(arguments);a.unshift(this,null);return goog.bind.apply(null,a)};Function.prototype.inherits=function(a){goog.inherits(this,a)};Function.prototype.mixin=function(a){goog.mixin(this.prototype,
a)}};var google={};google.Blog=function(a){var b=this;gadgets.rpc.call(null,"getBlogUrls",function(c){b.currentPost=c.currentPost||null;b.currentComments=c.currentComments||null;b.postFeed=c.postFeed||null;b.commentFeed=c.commentFeed||null;b.currentBlogUrl=c.currentBlogUrl||null;b.currentPostUrl=c.currentPostUrl||null;b.currentBlogId=c.currentBlogId||null;b.currentPostId=c.currentPostId||null;b.initialized=true;window.setTimeout(function(){a()},100)})};
...
google.Blog.prototype.getCurrentBlogId=function(){if(!this.initialized)throw"Not initialized";return this.currentBlogId};google.Blog.prototype.getCurrentPostId=function(){if(!this.initialized)throw"Not initialized";return this.currentPostId};goog.exportSymbol("google.Blog.prototype.getPostsFeedUrl",google.Blog.prototype.getPostsFeedUrl);goog.exportSymbol("google.Blog.prototype.getPostsJson",google.Blog.prototype.getPostsJson);goog.exportSymbol("google.Blog.prototype.getCommentsFeedUrl",google.Blog.prototype.getCommentsFeedUrl);
goog.exportSymbol("google.Blog.prototype.getCommentsJson",google.Blog.prototype.getCommentsJson);goog.exportSymbol("google.Blog.prototype.getCurrentPostFeedUrl",google.Blog.prototype.getCurrentPostFeedUrl);goog.exportSymbol("google.Blog.prototype.getCurrentPostJson",google.Blog.prototype.getCurrentPostJson);goog.exportSymbol("google.Blog.prototype.getCurrentCommentsFeedUrl",google.Blog.prototype.getCurrentCommentsFeedUrl);goog.exportSymbol("google.Blog.prototype.getCurrentCommentsJson",google.Blog.prototype.getCurrentCommentsJson);
goog.exportSymbol("google.Blog.prototype.getCurrentBlogUrl",google.Blog.prototype.getCurrentBlogUrl);goog.exportSymbol("google.Blog.prototype.getCurrentPostUrl",google.Blog.prototype.getCurrentPostUrl);goog.exportSymbol("google.Blog.prototype.getCurrentBlogId",google.Blog.prototype.getCurrentBlogId);goog.exportSymbol("google.Blog.prototype.getCurrentPostId",google.Blog.prototype.getCurrentPostId);
;
