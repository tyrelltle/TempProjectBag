...
wibiyadomain="http://cdn.wibiya.com/Toolbars/dir_0761/Toolbar_761661/";wibiyaScriptSrc="";var altToolbar=getQueryParam("toolbarObjId");var isIphone=(WIBIYA.agent=="iphone3")||(WIBIYA.agent=="iphone4");var isMobileFileExist=""!="";var isAlt=typeof altToolbar!="undefined";if(!isAlt&&!wibiyaToolbar.wibiya_isMobile){wibiyaScriptSrc=wibiyadomain+"toolbar_761661_4d8e61bcb3192.js";}
else if(isMobileFileExist&&wibiyaToolbar.wibiya_isMobile&&isIphone&&wibiyaToolbar.mobile==true)
{wibiyaScriptSrc=wibiyadomain+"mobile/";}
...
if(!window.wibiyaToolbar){window.wibiyaToolbar={};window.WIBIYA=window.WIBIYA||{};WIBIYA.Mobile=WIBIYA.Mobile||{};wibiyaToolbar.pl="false";wibiyaToolbar.nc="true";wibiyaToolbar.mobile=false;wibiyaToolbar.flashFix=false;wibiyaToolbar.runMode="standard";wibiyaToolbar.wibiyaTimeoutId=null;wibiyaToolbar.preventLoad=(typeof prevent_wibiya_load!="undefined")?prevent_wibiya_load:false;if(!wibiyaToolbar.preventLoad){if(wibiyaToolbar.runMode!="debug"||typeof getQueryParam('widebug')!="undefined"){if(wibiyaToolbar.runMode!="hide"||typeof getQueryParam('showbar')!="undefined"){if(typeof jQuery!="function"){loadjscssfile("http://cdn.wibiya.com/Scripts/jquery-1.4.2.min.js","js","head");}
wibiyaToolbar.framework={};wibiyaToolbar.id="761661";wibiyaToolbar.referrer=document.referrer;CheckJQueryLoader(wibiyaToolbar.id);}}}}